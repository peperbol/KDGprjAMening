...
@section('content')
   ...
   <div class="temp_content">
       ...
       <form id="edit_project_form" action="{{ url('update_project') }}" method="POST">
           {{ csrf_field() }}
           ...
           <div>
               <input type="checkbox" name="hidden" id="hidden" value="{{ $project->hidden }}" <?php if($project->hidden == 1) echo "checked" ?>>
